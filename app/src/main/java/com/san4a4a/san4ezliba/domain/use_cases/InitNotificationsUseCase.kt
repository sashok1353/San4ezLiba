...
class InitNotificationsUseCase @Inject constructor() {
    suspend operator fun invoke(entryActivity: Activity, destinationActivity: Activity, startWithList: List<String>, intentExtraName: String, intentExtraFlagName: String) {
